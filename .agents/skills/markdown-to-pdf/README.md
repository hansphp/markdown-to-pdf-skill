...
La revisión de instalación también probó el helper de Codex con un ZIP local equivalente al repositorio, dependencias instaladas en un entorno nuevo y una conversión estricta desde otra carpeta. La descarga pública queda pendiente de la publicación. `journey` conserva la limitación documentada en [diagramas Mermaid](#diagramas-mermaid).
