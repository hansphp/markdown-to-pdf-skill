...
| Instalación desde GitHub | Helper de `skill-installer` ejecutado contra la URL pública real: 117 archivos idénticos al paquete publicado, dependencias instaladas en un entorno nuevo y conversión estricta de 14 páginas desde otra carpeta, conservando el Markdown. Codex detectó el skill descargado, habilitado y sin errores. |
